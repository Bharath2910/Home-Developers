...
(function dFlip(DFLIP, $) {
  ...
  var defaults = DFLIP.defaults = {
    ...
    pdfjsCompatibilitySrc: "dflip/s/libs/compatibility.js",
    ...
    imageResourcesPath: "dflip/images/pdfjs/",
    cMapUrl: "dflip/cmaps/", //it's quite wierd how cmaps don't work properly with relative urls like others.. but is relative to pdf.min.js path
    ...
    if (typeof dFlipLocation == 'undefined' && DFLIP.autoDetectLocation != false) {
      $("script").each(function () {
        ...
        if ((src.indexOf("/dflip.js") > -1 || src.indexOf("/dflip.min.js") > -1 )
          && (src.indexOf("https://") > -1 || src.indexOf("https://") > -1 ) && src.indexOf("js/dflip.") > -1) {
